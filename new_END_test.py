...
binary_metallic_compounds = filter_binary_metallic_compounds(
    all_compounds, metallic_elements
)

# Filter binary non-metallic compounds
binary_non_metallic_compounds = [
    compound
    for compound in all_binary_compounds
    if compound not in binary_metallic_compounds
]
...
print(
    f"Total binary metallic compounds found: {len(binary_metallic_compounds)}"
)
print(
    f"Total binary non-metallic compounds found: {len(binary_non_metallic_compounds)}"
)
print(
    "Results have been saved to 'all_binary_compounds.csv', 'binary_metallic_compounds.csv', and 'binary_non_metallic_compounds.csv'"
)
